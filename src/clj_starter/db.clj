...
;; Taken from https://github.com/seancorfield/usermanager-example
...
(comment
  (populate my-db "sqlite")
  (get-users db)
  (get-departments db)
  (get-department-by-id db 4)
  )
